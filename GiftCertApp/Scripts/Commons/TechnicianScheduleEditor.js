          ...
          <div className='modal-content'>
            ...
            <div className='modal-body'>
              <form className='form-horizontal'>
                ...
                <div className='form-group'>
                  <div className='col-xs-12'>
                    <label className='col-xs-4 form-label'>Time Off</label>
                    <div className='col-xs-8'>
                      <input type='number' step='any' className='form-control' value={this.state.schedule.get('timeOff')}
                ...
                <div className='form-group'>
                  <div className='col-xs-12'>
                    <label className='col-xs-4 form-label'>Overtime</label>
                    <div className='col-xs-8'>
                      <input type='number' step='any' className='form-control' value={this.state.schedule.get('overtime')}
