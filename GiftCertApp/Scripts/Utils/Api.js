...
export function getGcType(callback) {
    return axios.get('/api/GcType')
        .then(callback)
...
export function queryGiftCerts(params, callback) {
    return axios.post('/api/GiftCert/PostGiftCertByFilter', params)
        .then(callback);
}
