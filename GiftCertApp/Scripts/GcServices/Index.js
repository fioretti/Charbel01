...
import RemoveGcServiceConfirmation from 'RemoveGcServiceConfirmation'
    ...
    render() {
        ...
        return (<div>
            ...
            <div style={style.mainAction}>
                <button className='btn btn-primary' onClick={this.onNewService}>
...
export default connect(mapStateToProps, mapDispatchToProps)(GcServices)
