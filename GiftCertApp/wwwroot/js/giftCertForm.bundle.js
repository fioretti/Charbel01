...
/***/ (function(module, exports, __webpack_require__) {
	...
	;(function (global, factory) {
	    true ? factory(__webpack_require__(143)) :
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.removeLotFromDevice = removeLotFromDevice;
	exports.characteristicChanged = characteristicChanged;
	exports.testSelectionLoaded = testSelectionLoaded;
	exports.addTest = addTest;
	exports.clearTestSelection = clearTestSelection;
	exports.removeTest = removeTest;
	exports.copyTest = copyTest;
	exports.testModified = testModified;
	exports.conditionModified = conditionModified;
	exports.formDataChanged = formDataChanged;
	exports.actionDataChanged = actionDataChanged;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.testValidationState = testValidationState;
	exports.conditionValidationState = conditionValidationState;
	...
	function testValidationState(test) {
	  var numTemperaturesValue = test.get('numTemperatures');
	  var temperatureIsNotValid = dataUtils.isEmpty(numTemperaturesValue) || !dataUtils.validNumber(numTemperaturesValue);

	  var numDevicesPerLotValue = test.get('numOfDevices');
	  var numDevicesPerLotValueIsNotValue = dataUtils.isEmpty(numDevicesPerLotValue) || !dataUtils.validNumber(numDevicesPerLotValue);
	...
	function conditionValidationState(conditionSelection) {
	  return {
